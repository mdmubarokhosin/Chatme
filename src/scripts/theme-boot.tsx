  ...
  const code = `
    (function () {
      try {
        ...
        /* ChatBD manual dark-mode override (chat app header toggle) */
        var manualDark = null;
        try {
          manualDark = window.localStorage.getItem("chatbd-dark-mode");
        } catch (e) {}
        if (manualDark === "true") mode = "dark";
        if (manualDark === "false") mode = "light";
